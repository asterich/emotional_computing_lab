...
def dictionary_map(free_emotions: List[str], utterance: str = "", context: str = "") -> Tuple[str, str, str, float]:
    ...
    if labels:
        ...
        method = "dictionary_tie_break" if not unresolved else "hybrid_tie_break"
        return top[0][0], method, "Dictionary labels tied; used first generated emotion as tie-break.", 0.6
